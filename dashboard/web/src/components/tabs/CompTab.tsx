  ...
  return (
    <div className="p-3.5 flex flex-col gap-3" style={{ color: "var(--tp)" }}>
      <div className="flex items-start justify-between flex-wrap gap-2">
        ...
        <div className="flex gap-1.5">
          <span className="font-mono text-[8px] font-bold px-2 py-[3px] rounded-[3px]"
            style={{ background: "rgba(59,130,246,.18)", color: "#60A5FA" }}>IFS · v48r1</span>
          <span className="font-mono text-[8px] font-bold px-2 py-[3px] rounded-[3px]"
            style={{ background: "rgba(168,85,247,.18)", color: "#C084FC" }}>AIFS · preview</span>
        </div>
      </div>
      ...
      <div className="rounded-lg px-3 py-2.5 text-[10px] leading-relaxed"
        ...
        <strong style={{ color: "#C084FC" }}>Note:</strong> illustrative until the AIFS
